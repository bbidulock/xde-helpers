[xde-helpers -- read me first file.  @DATE]: #
...
The quickest and easiest way to get `xde-helpers` up and running
...
This will configure, compile and install `xde-helpers` the quickest.
...
[5]: INSTALL
[6]: COPYING
[7]: https://github.com/bbidulock/xde-helpers/issues
